...
public class E02 {
    public static void main(String[] args) {
        ...
        System.out.println(getCharFromString("Java", 8));//olmayan index kullanıldıgı icin Exaption atar
    ...
    public static char getCharFromString(String str, int idx){
        ...
        try {
            ...
            idx = Math.abs(idx);//negatif sayı verirse kullanıcı bu method pozitife cevirir.
            idx = idx % str.length();
            return str.charAt(idx);
        }
    }
