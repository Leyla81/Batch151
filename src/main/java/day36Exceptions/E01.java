...
public class E01 {
    ...
    */
    ...
    public static void getCharFromString(String s, int a, int b){
        ...
        }catch ( ArithmeticException e){//int class ında gelebilecek exception ı handle etmek icin yakala kodu
            System.out.println("Do not divide by zero...");
        }catch (StringIndexOutOfBoundsException e){ //String bolumundeki exception'ı handle etmede yakalama kodu
