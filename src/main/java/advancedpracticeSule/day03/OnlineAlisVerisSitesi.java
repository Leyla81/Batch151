package advancedpracticeSule.day03;
...
public class OnlineAlisVerisSitesi {
    ...
    public static void musteriSecim() {
      ...
      urunListesiniGoster();//urun Listesini gormek method olusturdum
      ...
      if (urunKodu >= 0 && urunKodu <= urunListesi.size()) {
        ...
        devamMi();//devam edip etmeyecegini ogrenmek icin devamMi() methodunu olusturduk 67 ile 70. satır
    ...
    private static void devamMi() {
      ...
      if (devamMi == 1) {
        ...
        odemeYap();//devam etmek istemezse odemeyap() metodu olusturduk 84 ile92 arasındaki satır daki method
