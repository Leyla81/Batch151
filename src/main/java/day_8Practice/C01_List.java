...
public class C01_List {
    ...
    */
        ...
        //add ()methodu ile tek tek de eklene bilirdi
        System.out.println(list);
        for (int i = 0; i <list.size() ; i++) {
            if(list.get(i)>10){ //get() metodu i. indexi getirir.
                list.set(i,list.get(i)*2);//set()metodu degistirir
            }
        }
        System.out.println("Ondan buyuk olanların 2 kat = " +list);
